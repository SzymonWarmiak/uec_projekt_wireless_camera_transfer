...
##Pmod Header JA
##Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports spi_cs_n]
...
##Sch name = XA4_P
set_property PACKAGE_PIN N2 [get_ports servo_uart_rx]
	set_property IOSTANDARD LVCMOS33 [get_ports servo_uart_rx]
	set_property PULLUP true [get_ports servo_uart_rx]
##Sch name = XA1_N
