...
module ov7670_configurator (
    ...
    initial begin
        ...
        init_rom[8]  = 16'h3A04;
        init_rom[9]  = 16'h1438;
        init_rom[10] = 16'h4fb3;
        init_rom[11] = 16'h50b3;
        init_rom[12] = 16'h5100;
        init_rom[13] = 16'h523d;
        init_rom[14] = 16'h53A7;
        init_rom[15] = 16'h54e4;
        init_rom[16] = 16'h589e;
        init_rom[17] = 16'h3dc0;
    ...
    always_ff @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            case (state)
                ...
                ACK_D: begin
                    scl_out <= 1'b0;
                    state <= (bit_cnt == 0) ? STOP_A : SEND_BIT_A;
                end
